<!--<template>
  <div id="app">
    <button v-on:click="sendMessage('Hewo')">Send Message</button>
  </div>
</template>-->
...
/*
    <div>
      <input type="range" min="1" max="10" value="5" id="dataRateSlider"
      v-on:change="sendDataRate()"/>
...
var upcount=0; var downcount=0; var beatcount=0; var heartbeat=0;
var datetime; var datasplit; var data; var lastbeattime;
function removeData(){
